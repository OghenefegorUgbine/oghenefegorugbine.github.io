...
| --- | --- | --- | --- |
| `degree-certificates/` | **Yes** | Public copies of the École des Mines de Saint-Étienne master's diploma, the École Centrale de Lyon certificate of achievement, and the CRUTECH bachelor's degree certificate | Published in full at your request, exactly as issued, with nothing on the certificates covered or removed. These are the degree certificates only; no transcripts are included. Note: some of these documents show your date of birth and birthplace, since that's printed on the certificate itself. |
